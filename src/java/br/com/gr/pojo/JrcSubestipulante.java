...
/**
 * JrcSubestipulante generated by hbm2java
 */
public class JrcSubestipulante  implements java.io.Serializable {


     private long idSubestipulante;
    ...
    public JrcSubestipulante() {
    }

	
    public JrcSubestipulante(long idSubestipulante, JrcEmpresa jrcEmpresa, JrcPessoa jrcPessoa, JrcUsuario jrcUsuario, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro) {
        this.idSubestipulante = idSubestipulante;
    ...
    public JrcSubestipulante(long idSubestipulante, JrcEmpresa jrcEmpresa, JrcPessoa jrcPessoa, JrcUsuario jrcUsuario, String codigoRef, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro, Set jrcSeguroConfigs) {
       this.idSubestipulante = idSubestipulante;
       this.jrcEmpresa = jrcEmpresa;
       this.jrcPessoa = jrcPessoa;
       this.jrcUsuario = jrcUsuario;
    ...
    public long getIdSubestipulante() {
        return this.idSubestipulante;
    }
    
    public void setIdSubestipulante(long idSubestipulante) {
        this.idSubestipulante = idSubestipulante;
    }
