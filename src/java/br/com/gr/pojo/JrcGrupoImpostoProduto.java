...
/**
 * JrcGrupoImpostoProduto generated by hbm2java
 */
public class JrcGrupoImpostoProduto  implements java.io.Serializable {


     private long idGrupoImpostoProduto;
    ...
    public JrcGrupoImpostoProduto() {
    }

	
    public JrcGrupoImpostoProduto(long idGrupoImpostoProduto, JrcEmpresa jrcEmpresa, JrcUsuario jrcUsuario, String descBreve, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro) {
        this.idGrupoImpostoProduto = idGrupoImpostoProduto;
    ...
    public JrcGrupoImpostoProduto(long idGrupoImpostoProduto, JrcEmpresa jrcEmpresa, JrcUsuario jrcUsuario, String descBreve, String descLonga, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro, Set jrcProdutos) {
       this.idGrupoImpostoProduto = idGrupoImpostoProduto;
       this.jrcEmpresa = jrcEmpresa;
       this.jrcUsuario = jrcUsuario;
       this.descBreve = descBreve;
    ...
    public long getIdGrupoImpostoProduto() {
        return this.idGrupoImpostoProduto;
    }
    
    public void setIdGrupoImpostoProduto(long idGrupoImpostoProduto) {
        this.idGrupoImpostoProduto = idGrupoImpostoProduto;
    }
