...
/**
 * JrcCapitalizacao generated by hbm2java
 */
public class JrcCapitalizacao  implements java.io.Serializable {


     private long idCapitalizacao;
    ...
    public JrcCapitalizacao() {
    }

	
    public JrcCapitalizacao(long idCapitalizacao, JrcEmpresa jrcEmpresa, JrcPessoa jrcPessoa, JrcUsuario jrcUsuario, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro) {
        this.idCapitalizacao = idCapitalizacao;
    ...
    public JrcCapitalizacao(long idCapitalizacao, JrcEmpresa jrcEmpresa, JrcPessoa jrcPessoa, JrcUsuario jrcUsuario, String codigoRef, String susep, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro, Set jrcSeguroConfigs) {
       this.idCapitalizacao = idCapitalizacao;
       this.jrcEmpresa = jrcEmpresa;
       this.jrcPessoa = jrcPessoa;
       this.jrcUsuario = jrcUsuario;
    ...
    public long getIdCapitalizacao() {
        return this.idCapitalizacao;
    }
    
    public void setIdCapitalizacao(long idCapitalizacao) {
        this.idCapitalizacao = idCapitalizacao;
    }
