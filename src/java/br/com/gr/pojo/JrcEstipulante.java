...
/**
 * JrcEstipulante generated by hbm2java
 */
public class JrcEstipulante  implements java.io.Serializable {


     private long idEstipulante;
    ...
    public JrcEstipulante() {
    }

	
    public JrcEstipulante(long idEstipulante, JrcEmpresa jrcEmpresa, JrcPessoa jrcPessoa, JrcUsuario jrcUsuario, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro) {
    ...
    public JrcEstipulante(long idEstipulante, JrcEmpresa jrcEmpresa, JrcPessoa jrcPessoa, JrcUsuario jrcUsuario, String codigoRef, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro, Set jrcSeguroConfigs) {
       this.idEstipulante = idEstipulante;
       this.jrcEmpresa = jrcEmpresa;
       this.jrcPessoa = jrcPessoa;
       this.jrcUsuario = jrcUsuario;
    ...
    public long getIdEstipulante() {
        return this.idEstipulante;
    }
    
    public void setIdEstipulante(long idEstipulante) {
        this.idEstipulante = idEstipulante;
    }
