...
/**
 * JrcMotorista generated by hbm2java
 */
public class JrcMotorista  implements java.io.Serializable {
    ...
    public JrcMotorista(long idMotorista, JrcEmpresa jrcEmpresa, JrcPessoa jrcPessoa, JrcUsuario jrcUsuario, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro) {
    ...
    public JrcMotorista(long idMotorista, JrcEmpresa jrcEmpresa, JrcPessoa jrcPessoa, JrcUsuario jrcUsuario, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro, Set jrcVeiculos, Set jrcNotaFiscals, Set jrcRecebimentos) {
       this.idMotorista = idMotorista;
       this.jrcEmpresa = jrcEmpresa;
       this.jrcPessoa = jrcPessoa;
       this.jrcUsuario = jrcUsuario;
