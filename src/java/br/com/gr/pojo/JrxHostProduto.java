...
/**
 * JrxHostProduto generated by hbm2java
 */
public class JrxHostProduto  implements java.io.Serializable {


     private long idHostProduto;
    ...
    public JrxHostProduto() {
    }

	
    public JrxHostProduto(long idHostProduto, JrcEmpresa jrcEmpresa, JrcUsuario jrcUsuario, String descBreve, boolean indSemReferencia, boolean indAtivo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro) {
        this.idHostProduto = idHostProduto;
    ...
    public JrxHostProduto(long idHostProduto, JrcEmpresa jrcEmpresa, JrcUsuario jrcUsuario, String descBreve, String descLonga, boolean indSemReferencia, boolean indAtivo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro, Set jrxHostTransacaos) {
       this.idHostProduto = idHostProduto;
       this.jrcEmpresa = jrcEmpresa;
       this.jrcUsuario = jrcUsuario;
       this.descBreve = descBreve;
    ...
    public long getIdHostProduto() {
        return this.idHostProduto;
    }
    
    public void setIdHostProduto(long idHostProduto) {
        this.idHostProduto = idHostProduto;
    }
