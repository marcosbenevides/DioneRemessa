...
/**
 * JrcTipoFormaPagamento generated by hbm2java
 */
public class JrcTipoFormaPagamento  implements java.io.Serializable {


     private long idTipoFormaPagamento;
    ...
    public JrcTipoFormaPagamento() {
    }

	
    public JrcTipoFormaPagamento(long idTipoFormaPagamento, JrcEmpresa jrcEmpresa, JrcUsuario jrcUsuario, String descBreve, String flagTipoPagto, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro) {
    ...
    public JrcTipoFormaPagamento(long idTipoFormaPagamento, JrcEmpresa jrcEmpresa, JrcUsuario jrcUsuario, String descBreve, String descLonga, String flagTipoPagto, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro, Set jrcFormaPagamentos) {
       this.idTipoFormaPagamento = idTipoFormaPagamento;
       this.jrcEmpresa = jrcEmpresa;
       this.jrcUsuario = jrcUsuario;
       this.descBreve = descBreve;
    ...
    public long getIdTipoFormaPagamento() {
        return this.idTipoFormaPagamento;
    }
    
    public void setIdTipoFormaPagamento(long idTipoFormaPagamento) {
        this.idTipoFormaPagamento = idTipoFormaPagamento;
    }
