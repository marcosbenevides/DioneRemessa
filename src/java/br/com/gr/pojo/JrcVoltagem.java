...
/**
 * JrcVoltagem generated by hbm2java
 */
public class JrcVoltagem  implements java.io.Serializable {


     private long idVoltagem;
    ...
    public JrcVoltagem(long idVoltagem, JrcEmpresa jrcEmpresa, JrcUsuario jrcUsuario, String codigo, String descBreve, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro) {
    ...
    public JrcVoltagem(long idVoltagem, JrcEmpresa jrcEmpresa, JrcUsuario jrcUsuario, String codigo, String descBreve, String descLonga, Date dtInicioPeriodo, Date dtFimPeriodo, Date dtInclusao, Date dtAlteracao, long versaoSistema, long versaoRegistro, Set jrcProdutos) {
       this.idVoltagem = idVoltagem;
       this.jrcEmpresa = jrcEmpresa;
       this.jrcUsuario = jrcUsuario;
       this.codigo = codigo;
    ...
    public long getIdVoltagem() {
        return this.idVoltagem;
    }
    
    public void setIdVoltagem(long idVoltagem) {
        this.idVoltagem = idVoltagem;
    }
